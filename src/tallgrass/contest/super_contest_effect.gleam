...
///
/// ```gleam
/// let result = super_contest_effect.fetch(DefaultPagination)
/// let result = super_contest_effect.fetch(Paginate(limit: 100, offset: 0))
/// ```
...
///
/// ```gleam
/// use res <- result.try(super_contest_effect.fetch(DefaultPagination))
