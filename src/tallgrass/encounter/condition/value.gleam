...
pub fn fetch_resource(client: Client, resource: Resource) {
  client.fetch_resource(client, resource, encounter_condition_value())
}
...
pub fn fetch_by_id(client: Client, id: Int) {
  client.fetch_by_id(client, path, id, encounter_condition_value())
}
...
pub fn fetch_by_name(client: Client, name: String) {
  client.fetch_by_name(client, path, name, encounter_condition_value())
}
