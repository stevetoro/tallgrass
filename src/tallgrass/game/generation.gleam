...
///
/// ```gleam
/// let result = generation.fetch(DefaultPagination)
/// let result = generation.fetch(Paginate(limit: 100, offset: 0))
/// ```
...
///
/// ```gleam
/// use res <- result.try(generation.fetch(DefaultPagination))
