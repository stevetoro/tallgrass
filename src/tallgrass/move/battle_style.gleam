...
///
/// ```gleam
/// let result = battle_style.fetch(DefaultPagination)
/// let result = battle_style.fetch(Paginate(limit: 100, offset: 0))
/// ```
...
///
/// ```gleam
/// use res <- result.try(battle_style.fetch(DefaultPagination))
